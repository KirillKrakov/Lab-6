...
public class AuthorRaw implements Serializable {
    private String name;
    private LocalDateTime birthday;
    private String passportID;

    public AuthorRaw(String name, LocalDateTime birthday, String passportID) {
        this.name=name;
    ...
    public static AuthorRaw outOfString(String arg){
        String[] author = arg.split("~!~");
        return new AuthorRaw(author[0], LocalDateTime.parse(author[1], DateTimeFormatter.ISO_LOCAL_DATE_TIME), author[2]);
    }
    @Override
    public int hashCode() {
