...
public class LabWorkRaw implements Serializable{
    ...
    public String toString() {
        return name + "~!~" + coordinates.toString2() + "~!~" + minimalPoint +
                "~!~" + personalQualitiesMinimum + "~!~" + averagePoint
                + "~!~" + difficulty.getTitle() + "~!~" + author.toString2();
    }
    public static LabWorkRaw outOfString(String arg){
        String[] labWork = arg.split("~!~");
        LabWorkRaw lr = new LabWorkRaw(
                labWork[0],
