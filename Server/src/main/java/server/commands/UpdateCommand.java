...
public class UpdateCommand extends AbstractCommand {
    ...
    public boolean execute(String stringArgument, Object objectArgument) {
        try {
            ...
            Coordinates coordinates = labWorkRaw.getCoordinates().equals(new Coordinates((double) -1, (long) -1)) ? oldLabWork.getCoordinates() : labWorkRaw.getCoordinates();
            ...
            Float personalQualitiesMinimum = labWorkRaw.getPersonalQualitiesMinimum() == -1 ? oldLabWork.getPersonalQualitiesMinimum() : labWorkRaw.getPersonalQualitiesMinimum();
            ...
            Person author = labWorkRaw.getAuthor().equals(new Person("-", LocalDateTime.parse("0000-01-01t00:00:00", DateTimeFormatter.ISO_LOCAL_DATE_TIME),"-")) ? oldLabWork.getAuthor() : labWorkRaw.getAuthor();
